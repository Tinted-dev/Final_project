...
def clear_data():
    # Delete from dependent tables first to respect FK constraints
...
def seed_database():
    ...
    # Clear existing data by deleting rows instead of dropping tables
    clear_data()
    ...
    for region in regions:
        ...
        for loc_name in loc_names:
            location = Location(name=loc_name, region=region)
    ...
    # Add Services and associate with companies
